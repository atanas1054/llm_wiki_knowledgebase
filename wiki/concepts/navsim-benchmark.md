...
FLARE-4B RFT (91.4) is the **highest single-sample VLM-based NAVSIM-v1 result** in the wiki among papers with fair single-sample comparisons. WAM-Diff (91.0) slots in second but omits FLARE from its comparison table. DriveFine (90.7, 1xC) remains the most broadly-verified single-sample result with explicit head-to-head against contemporary methods. Approximate ordering: FLARE 91.4 > WAM-Diff 91.0 ≈ DualDriveVLA 91.0 > DriveFine 90.7 > Curious-VLA/WAM-Flow/AdaThinkDrive 90.3. Curious-VLA† (94.8 BoN-6) is the **best-of-N result**, matching human GT.
